...
class PhoneSpider(scrapy.Spider):
    ...
    base_url = "https://www.thegioididong.com/may-tinh-bang#c=522&o=17&pi="
    ...
    def start_requests(self):
        start_urls = [
            "https://www.thegioididong.com/may-tinh-bang#c=522&o=17&pi=1"
        ]
    ...
    def parse_info_phone(self, response):
        ...
        phone['company'] = phone['company'][14:len(phone['company'])]
        ...
        phone['name'] = phone['name'][14:len(phone['name'])]
